...
export const CONTRACT_ADDRESSES = {
  ...
  celoSepolia: {
    vault: process.env.NEXT_PUBLIC_VAULT_CONTRACT_ADDRESS || '0x996137a2906206284A5EaAc5c8b13B9b1162a563', // Fixed AttestifyVault
    cUSD: process.env.NEXT_PUBLIC_CUSD_CONTRACT_ADDRESS || "0x16ECBA51e18a4a7e61fdC417f0d47AFEeDfbed74", // Real Celo Sepolia cUSD
